...
function createE2eServerDefinitions(
  ...
  const learnerServers: readonly E2eServerDefinition[] = [
    ...
    },
    {
      ...
      env: {
        ...environment,
        ADMIN_API_ALLOWED_HOSTS: "127.0.0.1:4100",
        ADMIN_BETTER_AUTH_SECRET:
          "e2e-admin-auth-secret-must-have-32-characters",
        ADMIN_BETTER_AUTH_URL: "http://127.0.0.1:4100",
        ...
        LEARNER_API_ALLOWED_HOSTS: "localhost:4100",
        NODE_ENV: "test",
    ...
    },
    {
      ...
      env: {
        ...
        WEB_API_BASE_URL: "http://localhost:4100",
      },
      name: "learner web",
  ...
  return [
    ...learnerServers,
    {
      ...
      env: {
        ...environment,
        ADMIN_API_BASE_URL: "http://127.0.0.1:4100",
        ADMIN_ORIGIN: "http://127.0.0.1:3101",
        NEXT_PUBLIC_ADMIN_API_BASE_URL: "http://127.0.0.1:4100",
