...
function createE2eServerDefinitions(
  ...
  const learnerServers: readonly E2eServerDefinition[] = [
    ...
    },
    {
      ...
      env: {
        ...environment,
        ADMIN_API_ALLOWED_HOSTS: "admin-api.localhost:4100",
        ADMIN_BETTER_AUTH_SECRET:
          "e2e-admin-auth-secret-must-have-32-characters",
        ADMIN_BETTER_AUTH_URL: "http://admin-api.localhost:4100",
        ADMIN_ORIGIN: "http://admin-api.localhost:3101",
        API_PORT: "4100",
        BETTER_AUTH_SECRET: "e2e-auth-secret-must-have-32-characters",
        BETTER_AUTH_URL: "http://127.0.0.1:4100",
        DATABASE_URL: e2eDatabaseUrl,
        ENABLE_TEST_AUTH: "true",
        LEARNER_API_ALLOWED_HOSTS: "127.0.0.1:4100",
        NODE_ENV: "test",
    ...
    },
    {
      ...
      name: "learner web",
      readinessUrl: "http://127.0.0.1:3100/login",
    },
  ]
  ...
  return [
    ...learnerServers,
    {
      ...
      env: {
        ...environment,
        ADMIN_API_BASE_URL: "http://admin-api.localhost:4100",
        ADMIN_ORIGIN: "http://admin-api.localhost:3101",
        NEXT_PUBLIC_ADMIN_API_BASE_URL: "http://admin-api.localhost:4100",
        NEXT_PUBLIC_LEARNER_WEB_ORIGIN: "http://127.0.0.1:3100",
      },
      name: "admin web",
      readinessUrl: "http://admin-api.localhost:3101/login",
    },
  ]
}
