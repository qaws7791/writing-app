...
import { aiFeedbackStepDtoSchema } from "@workspace/core/modules/content/domain/steps/ai-feedback-step.dto"
import { categorizeStepDtoSchema } from "@workspace/core/modules/content/domain/steps/categorize-step.dto"
import { compareStepDtoSchema } from "@workspace/core/modules/content/domain/steps/compare-step.dto"
import { fillBlankStepDtoSchema } from "@workspace/core/modules/content/domain/steps/fill-blank-step.dto"
import { matchStepDtoSchema } from "@workspace/core/modules/content/domain/steps/match-step.dto"
import { multipleChoiceStepDtoSchema } from "@workspace/core/modules/content/domain/steps/multiple-choice-step.dto"
import { orderStepDtoSchema } from "@workspace/core/modules/content/domain/steps/order-step.dto"
import { readingStepDtoSchema } from "@workspace/core/modules/content/domain/steps/reading-step.dto"
import { selectStepDtoSchema } from "@workspace/core/modules/content/domain/steps/select-step.dto"
import { writeStepDtoSchema } from "@workspace/core/modules/content/domain/steps/write-step.dto"
