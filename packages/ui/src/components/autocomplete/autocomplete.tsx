...
import type { Booleanish } from "@workspace/ui/utils/assertion"
...
import { CloseIcon, IconChevronDown } from "@workspace/ui/components/icons"
 ...
 * -----------------------------------------------------------------------------------------------*/
type AutocompleteTriggerProps = ComponentPropsWithRef<typeof GroupPrimitive>
 ...
 * Autocomplete Value
 * -----------------------------------------------------------------------------------------------*/
type AutocompleteValueProps = ComponentPropsWithRef<typeof SelectValuePrimitive>
...
const AutocompletePopover = ({
  ...
  const onResize = useCallback(() => {
    if (triggerRef.current) {
      setTriggerWidth(triggerRef.current.clientWidth + "px")
    }
  }, [triggerRef])
 ...
 * Autocomplete Filter
 * -----------------------------------------------------------------------------------------------*/
type AutocompleteFilterProps = ComponentPropsWithRef<
  typeof AutocompletePrimitive
>
 ...
 * -----------------------------------------------------------------------------------------------*/
type AutocompleteClearButtonProps = ComponentPropsWithRef<"button">
