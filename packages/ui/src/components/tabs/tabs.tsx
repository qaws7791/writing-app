...
interface TabsRootProps
  extends ComponentPropsWithRef<typeof TabsPrimitive>, TabsVariants {
  children: ReactNode
  className?: string
}
 ...
 * Tabs List
 * -----------------------------------------------------------------------------------------------*/
interface TabListProps extends ComponentPropsWithRef<
  typeof TabListPrimitive<object>
> {
  children: ReactNode
  className?: string
}
 ...
 * Tab Indicator
 * -----------------------------------------------------------------------------------------------*/
interface TabIndicatorProps extends ComponentPropsWithRef<
...
interface TabPanelProps extends Omit<
  ComponentPropsWithRef<typeof TabPanelPrimitive>,
  "children"
> {
  children: ReactNode
  className?: string
