  ...
  units: [
    {
      ...
      lessons: [
        ...
        {
          id: "l3",
          title: "예시와 설명으로 의미 추론하기",
          state: "not-started",
        },
        {
          id: "l4",
          title: "문장에서 알맞은 쓰임 고르기",
          state: "not-started",
        },
        {
          id: "l5",
          title: "짧은 단락에서 어휘 확인하기",
          state: "not-started",
        },
      ],
    },
    {
      ...
      lessons: [
        ...
        {
          id: "l8",
          title: "수식어가 가리키는 대상 찾기",
          state: "not-started",
        },
        { id: "l9", title: "생략된 주어 되살리기", state: "not-started" },
        {
          id: "l10",
          title: "한 문장의 역할 관계 정리하기",
          state: "not-started",
        },
      ],
    },
    {
      ...
      lessons: [
        ...
        {
          id: "l13",
          title: "예시·부연이 붙는 자리 찾기",
          state: "not-started",
        },
        {
          id: "l14",
          title: "지시어가 가리키는 내용 확인하기",
          state: "not-started",
        },
        {
          id: "l15",
          title: "두 문장의 관계 한 줄로 쓰기",
          state: "not-started",
        },
      ],
    },
    {
      ...
      lessons: [
        {
          id: "l16",
          title: "핵심 문장과 보조 정보 구분하기",
          state: "not-started",
        },
        {
          id: "l17",
          title: "어휘와 문장 관계를 함께 읽기",
          state: "not-started",
        },
        {
          id: "l18",
          title: "오해하기 쉬운 표현 점검하기",
          state: "not-started",
        },
        { id: "l19", title: "짧은 글 의미 요약하기", state: "not-started" },
        {
          id: "l20",
          title: "종합: 정확히 읽고 확인하기",
          state: "not-started",
        },
      ],
    },
...
function CoursePattern({
  ...
  return (
    <div
      ...
      className={cn(
        "relative aspect-square overflow-hidden rounded-[1.25rem] bg-muted",
        className
      )}
      aria-hidden="true"
    >
...
function Curriculum({ course }: { course: CourseDetailData }) {
  ...
  return (
    ...
    >
      ...
      <Accordion
        defaultValue={openUnitId ? [openUnitId] : []}
        className="gap-3"
      >
