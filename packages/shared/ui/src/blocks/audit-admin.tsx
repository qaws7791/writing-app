...
const INITIAL_ENTRIES: AuditEntry[] = [
  {
    ...
    daysAgo: 0,
    summary:
      "Preview 검수를 통과한 레슨 4를 Live로 승격했습니다. 학습자 경로에 즉시 반영됩니다.",
    restorable: true,
  },
  {
    id: "aud-02",
    ...
    daysAgo: 0,
    summary:
      "역할이 열람에서 편집자로 변경되었습니다. 코스 초안 편집과 Preview 게시가 가능합니다.",
    restorable: false,
  },
  {
    id: "aud-03",
  ...
  },
  {
    ...
    daysAgo: 1,
    summary:
      "‘근거 제시’ 기준의 수준 설명을 구체화했습니다. Preview 채점에만 반영됩니다.",
    restorable: true,
  },
  {
    id: "aud-05",
  ...
  },
  {
    ...
    daysAgo: 3,
    summary:
      "내부 검수용 Preview 게시입니다. Live 승격 전에는 학습자 경로에 노출되지 않습니다.",
    restorable: true,
  },
  {
    id: "aud-07",
  ...
  },
  {
    ...
    daysAgo: 5,
    summary:
      "제출 마감을 8월 12일로 연장했습니다. 학습자 알림이 재발송되었습니다.",
    restorable: false,
  },
  {
    id: "aud-09",
  ...
  },
  {
    ...
    daysAgo: 10,
    summary:
      "임시 운영 권한이 만료되어 열람으로 변경되었습니다. Live 게시 권한이 제거됩니다.",
    restorable: false,
  },
  {
    id: "aud-11",
    ...
    daysAgo: 15,
    summary:
      "Preview 환경 피드백을 주기 샘플링해 feedback-audit에 적재했습니다.",
    restorable: false,
  },
  {
    id: "aud-12",
    ...
    daysAgo: 23,
    summary:
      "스텝 순서를 듣고→따라 말하기→점검으로 바꿨습니다. Sandbox 초안만 변경되었습니다.",
    restorable: true,
  },
  {
    id: "aud-13",
            ...
            <>
              <div className="flex flex-1 flex-col gap-5 overflow-auto p-6">
                ...
                <dl className="flex flex-col gap-4">
                  ...
                  <DetailRow label="유형">
                    {AUDIT_LOG_KIND_LABELS[selected.kind]}
                  </DetailRow>
                  <DetailRow label="환경">
                    {AUDIT_LOG_ENV_LABELS[selected.env]}
                  </DetailRow>
                  <DetailRow label="시각">
                    <time dateTime={selected.dateTime} className="tabular-nums">
                      {selected.dateTime.replace("T", " ")} ·{" "}
      ...
      <div className="flex flex-wrap items-end justify-between gap-2">
        <div className="min-w-0">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            환경과 행위 유형으로 좁혀 보고, 필요한 경우 이전 시점으로
            복원합니다.
          </p>
        </div>
      </div>
