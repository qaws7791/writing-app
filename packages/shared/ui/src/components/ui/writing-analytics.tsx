...
function WritingAnalyticsHeader({
  className,
  ...props
...
function WritingAnalyticsTitle({
  className,
  ...props
...
function WritingAnalyticsMetric({
  className,
  ...props
}: React.ComponentProps<"div">) {
  return (
...
function WritingAnalyticsMetricLabel({
  className,
  ...props
}: React.ComponentProps<"div">) {
  return (
...
function WritingAnalyticsMetricValue({
  className,
  ...props
}: React.ComponentProps<"div">) {
  return (
...
function WritingAnalyticsCriteria({
  className,
  ...props
...
function WritingAnalyticsCriterion({
  className,
  ...props
...
function WritingAnalyticsGenre({
  className,
  ...props
}: React.ComponentProps<"div">) {
  return (
