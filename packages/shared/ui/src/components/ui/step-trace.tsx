...
function StepTraceToolName({
  ...
  return (
    <code
      ...
      className={cn(
        "font-mono text-[11px] tracking-[-0.01em] text-foreground/85",
        className
      )}
      {...props}
    />
...
function StepTraceToolDuration({
  className,
  ...props
}: React.ComponentProps<"span">) {
  return (
