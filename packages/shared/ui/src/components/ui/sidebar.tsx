...
function SidebarSearch({
  ...
  return (
    ...
    >
      ...
      />
      <SidebarInput
        className={cn("ps-9", shortcut ? "pe-12" : "pe-3")}
        {...props}
      />
      {shortcut ? (
        <div
  ...
  "pointer-events-none absolute end-1.5 flex h-5 min-w-5 items-center justify-center rounded-full px-1.5 text-[0.6875rem] font-medium tabular-nums select-none group-data-[collapsible=icon]:hidden peer-data-[size=default]/menu-button:top-2 peer-data-[size=lg]/menu-button:top-3.5 peer-data-[size=sm]/menu-button:top-1.5",
  {
    variants: {
      variant: {
        ...
        success:
          "bg-success/12 text-success peer-data-active/menu-button:bg-success/16",
  ...
  compoundVariants: [
    {
      appearance: "ring",
      tone: "neutral",
      class: "border-muted-foreground/45",
    },
...
function SidebarMenuStatus({
  ...
  VariantProps<typeof sidebarMenuStatusVariants>) {
  return (
    <span
...
function SidebarMenuSkeleton({
  ...
  return (
    <div
      ...
      className={cn(
        "flex h-9 items-center gap-2.5 rounded-2xl px-2.5",
        className
      )}
      {...props}
    >
