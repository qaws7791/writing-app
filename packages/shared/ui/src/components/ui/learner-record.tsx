...
function LearnerRecordSectionTitle({
  className,
  ...props
}: React.ComponentProps<"div">) {
  return (
...
function LearnerRecordAttempts({
  className,
  ...props
}: React.ComponentProps<"div">) {
  return (
...
function LearnerRecordSubmissions({
  className,
  ...props
}: React.ComponentProps<"div">) {
  return (
