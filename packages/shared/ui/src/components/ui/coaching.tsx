...
function CoachingSource({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "rounded-3xl border border-border/70 bg-surface/70 px-5 py-4",
        className
      )}
      {...props}
    />
