  ...
  "group/insight flex w-full flex-col gap-2 rounded-3xl border px-4 py-4 text-left text-sm",
  {
    variants: {
      tone: {
        ...
        think: "border-info/25 bg-info/8 text-info",
...
function InsightEyebrow({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "text-xs font-medium text-muted-foreground group-data-[tone=think]/insight:text-info group-data-[tone=correct]/insight:text-success group-data-[tone=incorrect]/insight:text-destructive/75",
        className
      )}
      {...props}
    />
...
function InsightDescription({
  ...
  return (
    <div
      ...
      className={cn(
        "text-sm leading-6 text-pretty text-muted-foreground group-data-[tone=think]/insight:text-info/85 group-data-[tone=correct]/insight:text-success/85 group-data-[tone=incorrect]/insight:text-destructive/85 [&_p:not(:last-child)]:mb-3",
        className
      )}
      {...props}
    />
