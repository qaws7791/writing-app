...
function LearningProfileHeader({
  className,
  ...props
...
function LearningProfileTitle({
  ...
  return (
    <div
      ...
      className={cn(
        "text-xl font-semibold tracking-[-0.02em] text-balance",
        className
      )}
      {...props}
    />
...
function LearningProfileDescription({
  className,
  ...props
...
function LearningProfileSectionLabel({
  className,
  ...props
...
function LearningProfileSectionHint({
  className,
  ...props
}: React.ComponentProps<"p">) {
  return (
  ...
  "inline-flex min-h-10 items-center justify-center rounded-2xl border px-4 py-2 text-sm font-medium tracking-[-0.005em] transition-[background-color,border-color,color,box-shadow] duration-125 outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/25 disabled:pointer-events-none disabled:opacity-45",
  {
    variants: {
      selected: {
        ...
        false:
          "border-border/80 bg-card text-foreground hover:border-border hover:bg-accent/50",
      },
    },
    defaultVariants: {
      selected: false,
...
function LearningProfileSummary({
  className,
  ...props
...
function LearningProfileSummaryRow({
  className,
  ...props
}: React.ComponentProps<"div">) {
  return (
...
function LearningProfileSummaryTerm({
  className,
  ...props
...
function LearningProfileSummaryValue({
  className,
  ...props
...
function LearningProfileFooter({
  className,
  ...props
}: React.ComponentProps<"div">) {
  return (
