...
function PortfolioPieceExcerpt({
  className,
  ...props
  ...
  return (
    <p
      ...
      className={cn(
        "line-clamp-3 text-xs leading-5 text-pretty text-muted-foreground",
        className
      )}
      {...props}
    />
...
function PortfolioPieceFeedback({
  className,
  ...props
}: React.ComponentProps<"div">) {
  return (
...
function PortfolioPieceActions({
  className,
  ...props
}: React.ComponentProps<"div">) {
  return (
