...
function RubricCriterionDescription({
  className,
  ...props
...
function RubricJudgment({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "rounded-2xl border border-border/70 bg-surface/60 px-3.5 py-3",
        className
      )}
      {...props}
    />
...
function RubricJudgmentReason({
  ...
  return (
    <p
      ...
      className={cn(
        "mt-1 text-sm leading-6 text-pretty text-foreground/90",
        className
      )}
      {...props}
    />
