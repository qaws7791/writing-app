...
import {
  ...
  ChevronUpIcon,
  ChevronsUpDownIcon,
} from "#ui/components/icons/control-icons"
...
function SelectGroup({ className, ...props }: SelectPrimitive.Group.Props) {
  return (
    <SelectPrimitive.Group
      ...
      className={cn(
        "scroll-my-1.5 p-1.5 *:data-[slot=select-item]:pl-2.5",
        className
      )}
      {...props}
    />
