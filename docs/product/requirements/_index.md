...
| [REQ-ADM-3](./admin/req-adm-3-content-operations.md)  | 콘텐츠 운영       | `US-ADM-3`       | `SCR-103`, `SCR-104`, `SCR-109`                       | 기준 |
...
| [REQ-ADM-7](./admin/req-adm-7-resource-library.md)    | 자료실 공동 편집  | `US-ADM-7`       | `SCR-110`                                             | 계획 |
