...
| `US-ADM` | 어드민 운영자 유저 스토리 |

## 플랫폼

| ID                                                                 | 제목                     | 주 사용자 | 관련 요구사항 | 관련 화면                       | 상태 |
| ------------------------------------------------------------------ | ------------------------ | --------- | ------------- | ------------------------------- | ---- |
| [US-LRN-1](./platform/us-lrn-1-google-login.md)                    | Google 로그인            | 학습자    | `REQ-LRN-1`   | `SCR-002`                       | 기준 |
...
| [US-ADM-7](./admin/us-adm-7-collaborate-on-resources.md) | 자료실 공동 편집      | 운영자    | `REQ-ADM-7`   | `SCR-110`                                             | 기준 |
