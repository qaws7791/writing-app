...
| 작업                                 | 문서                                                                                                                                                      | 상태                                            |
| ------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| 모듈러 모놀리스 전체 개편            | [목표 아키텍처](./2026-07-22-modular-monolith-redesign/architecture-guide.md), [실행 계획](./2026-07-22-modular-monolith-redesign/implementation-plan.md) | 목표 아키텍처·실행 계획 확정, 전체 개편 대기    |
