...
| 2026-08-18 최종 코스 시드 재구축        | [`master-prompt-v2.md`](./2026-08-18-final-course-seed-rebuild/master-prompt-v2.md), [`master-prompt.md`](./2026-08-18-final-course-seed-rebuild/master-prompt.md)                            | 실행은 v2. 골격(코스~레슨)과 레슨별 스텝을 분리. JSON 생성·5타입 계약은 후속 |
