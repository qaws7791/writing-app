...
| `codex-skill-invocation-policy.md`      | 워크플로 스킬의 호출 조건을 정의한다.                     |
...
| `adr/ADR-0038-*.md`                     | 점검 고칠 일의 1차 표면을 본문 인라인 마크로 둔다.        |
