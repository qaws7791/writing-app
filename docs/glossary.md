...
- 글: 학습자가 소유하는 일반 텍스트 본문. 시작 시점 발행본에 고정된다.
- 도메인: 쓰기 과제를 묶는 제품 enum 10개.
- 유형: 관리자가 과제에 붙이는 이름.
- AI 점검: 고정 발행본과 본문을 외부 AI에 전달해 잘된 점, 과제 미충족, 고칠 일을 받는 단계.
- 작성 중 글: 아직 마치지 않았거나, 마친 뒤 본문을 고쳐 다시 작성 중인 글.
- 완료 글: 현재 본문 기준 성공 점검을 받은 뒤 마친 글.
