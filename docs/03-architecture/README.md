---
title: README
description: 플랫폼의 시스템 구조, 인증, 데이터 흐름, 배포, 파일 저장, 운영 제약을 다루는 문서들을 관리합니다.
---

이 섹션은 플랫폼의 기술 구조와 시스템 경계, 운영 방식을 정의합니다.

## 포함 문서

- [[tech-stack]]: 채택 기술과 선택 이유
- [[diagrams/README]]: 목표 아키텍처 다이어그램 허브
- [[api-overview]]: API 책임과 주요 리소스
