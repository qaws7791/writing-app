...
One of the many reasons I joined Figma was that I was intrigued by Figma’s sync engines: [Multiplayer](https://www.figma.com/blog/how-figmas-multiplayer-technology-works/) and [LiveGraph](https://www.figma.com/blog/livegraph-real-time-data-fetching-at-figma/). Multiplayer syncs collaborative editing between clients, while LiveGraph syncs data from our SQLite database. For this blogpost, I will be discussing lessons learned working on _LiveGraph_.
