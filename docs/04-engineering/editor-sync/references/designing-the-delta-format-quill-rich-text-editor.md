...
URL Source: https://quilljs.com/docs/guides/designing-the-delta-format

Published Time: Fri, 25 Jul 2025 05:20:26 UTC
...
If you are looking for a reference on _what_ Deltas are, the [Delta documentation](https://quilljs.com/docs/delta) is a more concise resource.

## [](https://quilljs.com/docs/guides/designing-the-delta-format#plain-text)Plain Text
...
### [](https://quilljs.com/docs/guides/designing-the-delta-format#compact)Compact
...
### [](https://quilljs.com/docs/guides/designing-the-delta-format#canonical)Canonical
...
## [](https://quilljs.com/docs/guides/designing-the-delta-format#line-formatting)Line Formatting
...
## [](https://quilljs.com/docs/guides/designing-the-delta-format#embedded-content)Embedded Content
...
`const img = {  image: {    url: 'https://quilljs.com/logo.png'  }};const f = {  formula: 'e=mc^2'};`
...
## [](https://quilljs.com/docs/guides/designing-the-delta-format#describing-changes)Describing Changes
...
#### [](https://quilljs.com/docs/guides/designing-the-delta-format#delete)Delete
...
#### [](https://quilljs.com/docs/guides/designing-the-delta-format#insert)Insert
...
#### [](https://quilljs.com/docs/guides/designing-the-delta-format#format)Format
...
#### [](https://quilljs.com/docs/guides/designing-the-delta-format#pitfalls)Pitfalls
...
#### [](https://quilljs.com/docs/guides/designing-the-delta-format#retain)Retain
...
#### [](https://quilljs.com/docs/guides/designing-the-delta-format#ops)Ops
...
Finally, we arrive at the [Delta format](https://quilljs.com/docs/delta), as it exists today.
