...
| 3    | packages/database — 스키마 확장       | ✅ 완료 | writing_transactions, writing_versions, writings.version  |
...
| 17   | 통합 점검                             | ✅ 완료 | 타입체크 통과 (기존 writing-content-schema 에러 6개 제외) |
...
| 단계 | 작업                                     | 상태    | 비고                                |
| ---- | ---------------------------------------- | ------- | ----------------------------------- |
| 18   | core — SyncPushInput snapshotReason 추가 | ✅ 완료 | 수동 스냅샷 지원                    |
| 19   | web — useVersionHistory 훅 생성          | ✅ 완료 | 버전 목록/상세/복원 관리            |
| 20   | web — 버전 기록 모달 API 연결            | ✅ 완료 | mock 제거, 실 데이터 표시           |
| 21   | web — 복원 기능 구현                     | ✅ 완료 | 확인 다이얼로그 + push(restoreFrom) |
| 22   | web — 수동 버전 저장 UI                  | ✅ 완료 | 헤더 메뉴 항목 추가                 |
| 23   | core — 단위 테스트 작성                  | ✅ 완료 | 5개 테스트 파일                     |
| 24   | web — 훅 테스트 작성                     | ✅ 완료 | useVersionHistory 테스트            |
| 25   | 포매팅/린팅/타입/테스트 검증             | 🔄 진행 | 전체 체크                           |

## 변경 이력

- 2026-03-23: 작업 계획 글 작성
- 2026-03-23: 전체 구현 완료, 타입체크 통과
- 2026-03-25: Phase 2 — 버전 기록 UI 완성 계획 추가
