...
describe("AI 피드백 repository", () => {
  it("느린 provider 호출 구간에는 SQLite write transaction을 열어 두지 않는다", async () => {
    const directory = mkdtempSync(join(tmpdir(), "ai-feedback-boundary-"))
