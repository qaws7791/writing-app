...
function logMessage(message: AuthEmailMessage): void {
  console.info(
    `[auth-email] ${message.kind} ${message.email} ${message.url} ${message.token}`
  )
}

export function createAuthEmailPort(): AuthEmailPort {
