  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="rounded-2xl bg-secondary-container px-5 py-4">
        <p className="mb-2 text-xs font-semibold tracking-widest text-on-surface-low uppercase">
          글쓰기 주제
        </p>
