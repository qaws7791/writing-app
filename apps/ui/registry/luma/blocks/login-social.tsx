...
function ProviderMark({ label, children }: { label: string; children: React.ReactNode }) {
  return (
 ...
 */
export function LoginSocial({ className, ...props }: React.ComponentProps<"div">) {
    ...
    >
      <main className="mx-auto flex w-full max-w-[24rem] flex-col justify-center px-6 py-16">
        ...
        <div className="flex flex-col gap-3">
          <Button type="button" variant="outline" size="lg" className="w-full justify-start gap-3">
        ...
        {!showEmail ? (
          ...
          <form className="flex flex-col gap-5" onSubmit={(event) => event.preventDefault()}>
            <FieldGroup className="gap-4">
              ...
              <Field>
                <FieldLabel htmlFor="login-social-password">비밀번호</FieldLabel>
                <Input
