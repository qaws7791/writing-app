...
function ReflectionHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
...
function ReflectionDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
...
function ReflectionFields({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function ReflectionField({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div data-slot="reflection-field" className={cn("flex flex-col gap-2", className)} {...props} />
  );
}

function ReflectionFieldLabel({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function ReflectionFieldInput({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function ReflectionActions({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
