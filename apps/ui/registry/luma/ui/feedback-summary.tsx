...
function FeedbackSummary({ className, ...props }: React.ComponentProps<"section">) {
  return (
    <section
...
function FeedbackSummaryHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
...
function FeedbackSummaryTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function FeedbackSummaryMeta({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
...
function FeedbackSummaryPriority({ className, ...props }: React.ComponentProps<"ol">) {
  return (
    <ol
...
const feedbackItemVariants = cva("flex flex-col gap-1.5 rounded-2xl border px-3.5 py-3", {
  variants: {
    priority: {
...
function FeedbackSummaryItemTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function FeedbackSummaryItemScope({
  ...
  return (
    <span
      ...
      className={cn("text-[11px] font-medium tracking-[0.02em] text-muted-foreground", className)}
      {...props}
    >
      {children ?? (priority !== undefined ? FEEDBACK_PRIORITY_LABELS[priority] : undefined)}
    </span>
  );
}

function FeedbackSummaryItemBody({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
...
function FeedbackSummaryActions({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
