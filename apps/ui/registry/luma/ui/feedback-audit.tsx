...
type FeedbackAuditScoreKind = "accuracy" | "evidence" | "tone" | "scope" | "effect";
...
function FeedbackAudit({ className, ...props }: React.ComponentProps<"section">) {
  return (
    <section
...
function FeedbackAuditHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
...
function FeedbackAuditTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function FeedbackAuditList({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
...
function FeedbackAuditSampleBody({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function FeedbackAuditScores({ className, ...props }: React.ComponentProps<"dl">) {
  return (
    <dl
...
function FeedbackAuditScoreValue({ className, ...props }: React.ComponentProps<"dd">) {
  return (
    <dd
...
function FeedbackAuditActions({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
