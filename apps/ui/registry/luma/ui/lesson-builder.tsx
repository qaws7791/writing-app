...
function LessonBuilder({ className, ...props }: React.ComponentProps<"section">) {
  return (
    <section
      data-slot="lesson-builder"
      className={cn("@container/lesson-builder flex w-full flex-col gap-4", className)}
      {...props}
    />
  );
}

function LessonBuilderHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
...
function LessonBuilderTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function LessonBuilderBody({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function LessonBuilderPalette({ className, ...props }: React.ComponentProps<"aside">) {
  return (
    <aside
...
function LessonBuilderPaletteLabel({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function LessonBuilderCanvas({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function LessonBuilderStepIndex({ className, children, ...props }: React.ComponentProps<"span">) {
  return (
    <span
...
function LessonBuilderStepType({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
...
function LessonBuilderStepBody({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="lesson-builder-step-body"
      className={cn("col-start-2 min-w-0 text-sm leading-6 text-pretty", className)}
      {...props}
    />
  );
}

function LessonBuilderStepActions({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function LessonBuilderStepEditor({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function LessonBuilderStepInsert({ className, ref, ...props }: React.ComponentProps<"button">) {
  return (
    <button
      ref={ref}
      type="button"
...
function LessonBuilderEmpty({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function LessonBuilderInspector({ className, ...props }: React.ComponentProps<"aside">) {
  return (
    <aside
...
function LessonBuilderInspectorField({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function LessonBuilderInspectorLabel({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function LessonBuilderInspectorValue({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
