...
type PublishWorkflowStepState = "draft" | "review" | "scheduled" | "published" | "rolled-back";
...
function PublishWorkflow({ className, ...props }: React.ComponentProps<"section">) {
  return (
    <section
...
function PublishWorkflowHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
...
function PublishWorkflowTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function PublishWorkflowSteps({ className, ...props }: React.ComponentProps<"ol">) {
  return (
    <ol
...
function PublishWorkflowMeta({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
...
function PublishWorkflowActions({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
