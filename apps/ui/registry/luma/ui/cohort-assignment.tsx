...
function CohortAssignment({ className, ...props }: React.ComponentProps<"section">) {
  return (
    <section
...
function CohortAssignmentHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
...
function CohortAssignmentTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function CohortAssignmentMeta({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
...
function CohortAssignmentMembers({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
...
function CohortAssignmentTargets({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
...
function CohortTargetTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function CohortAssignmentDeadline({ className, ...props }: React.ComponentProps<"time">) {
  return (
    <time
...
function CohortAssignmentExceptions({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
...
function CohortAssignmentException({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
...
function CohortAssignmentActions({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
