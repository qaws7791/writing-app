...
function ProvenancePanel({ className, ...props }: React.ComponentProps<"section">) {
  return (
    <section
...
function ProvenancePanelHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
...
function ProvenancePanelTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function ProvenanceList({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul data-slot="provenance-list" className={cn("flex flex-col gap-2", className)} {...props} />
  );
}
...
function ProvenanceRowMeta({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn("col-start-2 text-xs leading-5 text-muted-foreground", className)}
      {...props}
    />
  );
}

function ProvenanceRowModel({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
...
function ProvenanceRowStatus({
  ...
  children,
  ...props
}: React.ComponentProps<"span"> & VariantProps<typeof provenanceRowStatusVariants>) {
  return (
    <span
...
function ProvenanceRowActions({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="provenance-row-actions"
      className={cn("col-start-3 flex flex-wrap items-center gap-1.5", className)}
      {...props}
    />
  );
}
