...
function AdminOverview({ className, ...props }: React.ComponentProps<"section">) {
  return (
    <section
...
function AdminOverviewHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
...
function AdminOverviewTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function AdminOverviewList({ className, ...props }: React.ComponentProps<"ol">) {
  return (
    <ol
...
function AdminOverviewItemTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function AdminOverviewItemReason({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
...
function AdminOverviewItemMeta({
  ...
  return (
    <p
      ...
      {...props}
    >
      {children ?? (severity ? ADMIN_OVERVIEW_SEVERITY_LABELS[severity] : undefined)}
    </p>
  );
}

function AdminOverviewItemActions({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
