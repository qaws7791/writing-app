...
function ProseCaption({ className, ...props }: React.ComponentProps<"figcaption">) {
  return (
    <figcaption
      data-slot="prose-caption"
      className={cn("px-1 pt-2 text-xs leading-5 text-muted-foreground", className)}
      {...props}
    />
  );
}
...
export { Prose, ProseFigure, ProseCaption, ProseBody, ProseSource };
