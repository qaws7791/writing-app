...
function InterventionQueue({ className, ...props }: React.ComponentProps<"section">) {
  return (
    <section
...
function InterventionQueueHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
...
function InterventionQueueTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function InterventionQueueMeta({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
...
function InterventionQueueList({ className, ...props }: React.ComponentProps<"ol">) {
  return (
    <ol
...
const interventionItemVariants = cva(
  "flex flex-col gap-1.5 rounded-2xl border border-border/70 bg-card px-3.5 py-3",
  {
    variants: {
      reason: {
        "repeated-errors": "border-foreground/15 bg-foreground/[0.03] dark:bg-foreground/[0.05]",
        inactive: "",
        "late-submission": "",
      },
    },
...
function InterventionItemName({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function InterventionItemEvidence({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="intervention-item-evidence"
      className={cn("text-xs leading-5 text-pretty text-muted-foreground tabular-nums", className)}
      {...props}
    />
  );
}

function InterventionItemActions({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
