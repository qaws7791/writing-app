...
function CourseOverview({ className, ...props }: React.ComponentProps<"article">) {
  return (
    <article
...
function CourseOverviewHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
...
function CourseOverviewEyebrow({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
...
function CourseOverviewTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="course-overview-title"
      className={cn("text-2xl font-semibold tracking-[-0.025em] text-balance", className)}
      {...props}
    />
  );
}

function CourseOverviewLead({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
...
function CourseOverviewFacts({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
...
function CourseOverviewFact({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
...
function CourseOverviewSection({ className, ...props }: React.ComponentProps<"section">) {
  return (
    <section
...
function CourseOverviewSectionTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function CourseOverviewList({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
...
function CourseOverviewItem({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
...
function CourseOverviewGenres({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
...
function CourseOverviewGenre({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
...
function CourseOverviewSamples({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
...
function CourseOverviewSample({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
...
function CourseOverviewSampleLabel({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
