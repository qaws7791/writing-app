...
function MistakeJournal({ className, ...props }: React.ComponentProps<"section">) {
  return (
    <section
...
function MistakeJournalHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
...
function MistakeJournalTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function MistakeJournalMeta({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
...
function MistakeJournalList({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
...
function MistakePatternLabel({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function MistakePatternDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
...
function MistakePatternActions({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
