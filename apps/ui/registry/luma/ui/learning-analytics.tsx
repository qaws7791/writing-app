...
function LearningAnalytics({ className, ...props }: React.ComponentProps<"section">) {
  return (
    <section
...
function LearningAnalyticsHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
...
function LearningAnalyticsTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function LearningAnalyticsMeta({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
...
function LearningAnalyticsGrid({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function LearningAnalyticsMetric({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function LearningAnalyticsMetricLabel({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function LearningAnalyticsMetricValue({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function LearningAnalyticsMetricHint({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
...
function LearningAnalyticsSeries({ className, ...props }: React.ComponentProps<"ol">) {
  return (
    <ol
...
function LearningAnalyticsRow({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
