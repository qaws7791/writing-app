...
function SourcePackHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
...
function SourcePackList({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul data-slot="source-pack-list" className={cn("flex flex-col gap-2", className)} {...props} />
  );
}
...
function SourceItemCitation({ className, ...props }: React.ComponentProps<"cite">) {
  return (
    <cite
...
function SourceItemActions({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
