...
function ContentReview({ className, ...props }: React.ComponentProps<"section">) {
  return (
    <section
...
function ContentReviewHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
...
function ContentReviewTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function ContentReviewDiff({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function ContentReviewComments({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
...
function ContentReviewComment({
  ...
  resolved = false,
  ...props
}: React.ComponentProps<"li"> & VariantProps<typeof contentReviewCommentVariants>) {
  return (
    <li
...
function ContentReviewCommentAuthor({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function ContentReviewCommentBody({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function ContentReviewCommentMeta({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
...
function ContentReviewAssignee({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-[11px] font-medium tracking-[0.02em]",
  {
    variants: {
      status: {
        ...
        "changes-requested": "border-foreground/15 bg-foreground/[0.04] text-foreground/80",
...
function ContentReviewActions({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
