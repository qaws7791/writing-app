...
function RubricEditor({ className, ...props }: React.ComponentProps<"section">) {
  return (
    <section
...
function RubricEditorHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
...
function RubricEditorTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function RubricEditorVersion({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
...
function RubricEditorCriterionHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function RubricEditorCriterionLabel({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function RubricEditorWeight({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
...
function RubricEditorLevels({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
...
const rubricEditorLevelVariants = cva("flex flex-col gap-1 rounded-xl border px-3 py-2.5", {
  variants: {
    tier: {
...
function RubricEditorLevelLabel({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function RubricEditorLevelDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
...
function RubricEditorExample({ className, ...props }: React.ComponentProps<"blockquote">) {
  return (
    <blockquote
...
function RubricEditorActions({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
