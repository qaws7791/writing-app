...
function Compose({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div data-slot="compose" className={cn("flex w-full flex-col gap-5", className)} {...props} />
  );
}
...
function ComposeClaim({ className, ...props }: React.ComponentProps<"blockquote">) {
  return (
    <blockquote
...
function ComposeEditor({ className, ...props }: React.ComponentProps<typeof Textarea>) {
  return (
    <Textarea
      data-slot="compose-editor"
      className={cn("min-h-40 rounded-3xl text-base leading-7 md:text-base", className)}
      {...props}
    />
  );
}
...
function ComposeReference({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
