...
type ItemAnalysisFlagKind = "high-dropout" | "hint-heavy" | "retry-heavy" | "distractor-bias";
...
function ItemAnalysis({ className, ...props }: React.ComponentProps<"section">) {
  return (
    <section
...
function ItemAnalysisHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
...
function ItemAnalysisTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function ItemAnalysisPrompt({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="item-analysis-prompt"
      className={cn("text-sm leading-6 font-medium tracking-[-0.01em] text-pretty", className)}
      {...props}
    />
  );
}

function ItemAnalysisStats({ className, ...props }: React.ComponentProps<"dl">) {
  return (
    <dl
...
function ItemAnalysisStat({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function ItemAnalysisStatLabel({ className, ...props }: React.ComponentProps<"dt">) {
  return (
    <dt
...
function ItemAnalysisStatValue({ className, ...props }: React.ComponentProps<"dd">) {
  return (
    <dd
...
function ItemAnalysisDistractors({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
...
function ItemAnalysisDistractor({
  ...
  selected = false,
  ...props
}: React.ComponentProps<"li"> & VariantProps<typeof itemAnalysisDistractorVariants>) {
  return (
    <li
...
function ItemAnalysisFlags({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
