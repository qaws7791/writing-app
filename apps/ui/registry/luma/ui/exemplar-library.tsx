...
function ExemplarLibrary({ className, ...props }: React.ComponentProps<"section">) {
  return (
    <section
...
function ExemplarLibraryHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
...
function ExemplarLibraryTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function ExemplarList({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul data-slot="exemplar-list" className={cn("flex flex-col gap-2", className)} {...props} />
  );
}

const exemplarVariants = cva("flex flex-col gap-3 rounded-2xl border px-3.5 py-3", {
  variants: {
    kind: {
...
function ExemplarAnnotations({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
...
function ExemplarAnnotation({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
