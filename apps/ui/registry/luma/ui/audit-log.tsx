...
function AuditLogHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
...
function AuditLogActor({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("shrink-0 text-xs font-medium tracking-[-0.01em]", className)}
      {...props}
    />
  );
}
...
function AuditLogKind({
  ...
  return (
    <span
      ...
      data-kind={kind}
      className={cn("col-start-2 w-fit", auditLogKindVariants({ kind }), className)}
      {...props}
    >
...
function AuditLogRestore({ className, ...props }: React.ComponentProps<"button">) {
  return (
    <button
      type="button"
...
function AuditLogEmpty({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex w-full flex-col items-center justify-center py-6", className)}
      {...props}
    />
  );
}
