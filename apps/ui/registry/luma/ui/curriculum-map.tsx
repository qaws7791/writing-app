...
function CurriculumMap({ className, ...props }: React.ComponentProps<"section">) {
  return (
    <section
...
function CurriculumMapHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
...
function CurriculumMapTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function CurriculumMapList({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
...
function CurriculumMapLink({ className, children, ...props }: React.ComponentProps<"li">) {
  return (
    <li
...
const curriculumMapNodeVariants = cva("flex flex-col gap-0.5 rounded-2xl border px-3 py-2.5", {
  variants: {
    kind: {
...
function CurriculumMapNodeBody({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function CurriculumMapEdge({ className, children, ...props }: React.ComponentProps<"div">) {
  return (
    <div
